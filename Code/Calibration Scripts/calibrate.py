...
CamL = cv2.VideoCapture('Calibration_cam1-18388636-0000.avi')
CamR = cv2.VideoCapture('Calibration_cam2-18505199-0000.avi')

if (CamL.isOpened()== False and CamR.isOpened()== False): 
  print("Error opening video stream or file")

while(CamL.isOpened() and CamR.isOpened() and id_image < 100):
    ...
    retL, cornersL = cv2.findChessboardCorners(grayL,(9,7),None)  # Same with the left camera
