...
for i in range(0, 69):   # Put the amount of pictures you have taken for the calibration inbetween range(0,?) wenn starting from the image number 0
    ...
    retR, cornersR = cv2.findChessboardCorners(ChessImaR,
                                               (9,7),None)  # Define the number of chees corners we are looking for
...
with open("right_roi", 'wb') as f:
    pickle.dump(roiR, f)

with open("left_roi", 'wb') as f:
    pickle.dump(roiL, f)

with open("left_stereo_map", 'wb') as f:
    pickle.dump(Left_Stereo_Map, f)

with open("right_stereo_map", 'wb') as f:
    pickle.dump(Right_Stereo_Map, f)
